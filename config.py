...
OUTPUT_ALSA_DEVICE = os.getenv('OUTPUT_ALSA_DEVICE', os.getenv('PIPER_OUTPUT_DEVICE', 'pulse'))
...
# STT Backend
STT_BACKEND = os.getenv('STT_BACKEND', 'cpu').lower()
...
PIPER_OUTPUT_DEVICE = os.getenv('PIPER_OUTPUT_DEVICE', 'pulse')
